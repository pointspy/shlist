...
//  Shlist
//
//  Created by Pavel Lyskov on 22.04.2020.
...
open class CornerRoundingView: UIView {
    ...
    private func updateMaskPath() {
        ...
        let newPath =
            self.isSquircle
            ? UIBezierPath(roundedRectIn: layer.bounds, cornerRadii: [roundedCorners: cornerRadius])
                .cgPath
            : UIBezierPath(
                roundedRect: layer.bounds, byRoundingCorners: roundedCorners,
