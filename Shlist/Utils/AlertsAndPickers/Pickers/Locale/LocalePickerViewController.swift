...
final class LocalePickerViewController: UIViewController {
    ...
    public typealias Selection = (LocaleInfoAlert?) -> Swift.Void
    ...
    fileprivate var orderedInfo = [String: [LocaleInfoAlert]]()
    fileprivate var sortedInfoKeys = [String]()
    fileprivate var filteredInfo: [LocaleInfoAlert] = []
    fileprivate var selectedInfo: LocaleInfoAlert?
    ...
    func updateInfo() {
        ...
        LocaleStore.fetch { [unowned self] result in
            ...
            case .success(let orderedInfo):
                let data: [String: [LocaleInfoAlert]] = orderedInfo
                /*
                 switch self.type {
                 case .currency:
    ...
    func info(at indexPath: IndexPath) -> LocaleInfoAlert? {
