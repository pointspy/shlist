...
extension UIAlertController {
    ...
    func addColorPicker(color: UIColor = .black, selection: ColorPickerViewControllerAlert.Selection?) {
        let selection: ColorPickerViewControllerAlert.Selection? = selection
        ...
        guard let vc = storyboard.instantiateViewController(withIdentifier: "ColorPicker") as? ColorPickerViewControllerAlert else { return }
        set(vc: vc)
...
class ColorPickerViewControllerAlert: UIViewController {
