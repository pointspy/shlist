...
class TinyConsoleViewController: UIViewController {
    ...
    private func setupConstraints() {
        ...
        if #available(iOS 11.0, *) {
            ...
            view.rightAnchor.constraint(equalTo: consoleTextView.rightAnchor).isActive = true
        }
        ...
        if #available(iOS 11.0, *) {
            ...
            view.rightAnchor.constraint(equalTo: stackView.rightAnchor, constant: 8).isActive = true
