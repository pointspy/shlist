...
{
    /// Returns the current ThemeHiglighter.
    open var theme : ThemeHiglighter!
    {
        didSet
        {
            themeChanged?(theme)
    ...
    open var themeChanged : ((ThemeHiglighter) -> Void)?
    ...
    /**
     ...
     - parameter to: ThemeHiglighter name
    ...
    open func setTheme(to name: String) -> Bool
    {
        ...
        theme =  ThemeHiglighter(themeString: themeString)
